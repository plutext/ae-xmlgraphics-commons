...
/* $Id: GraphicsUtil.java 750418M 2012-05-15 08:52:01Z (local) $ */
 ...
 * @version $Id: GraphicsUtil.java 750418M 2012-05-15 08:52:01Z (local) $
 */
  ...
  This is skanky debugging code that might be useful in the future:
            ...
            if (realG2D instanceof sun.awt.image.BufferedImageGraphics2D) {
                ...
                if (count == 34) {
                    ...
                    ae.java.awt.RenderingHints rh = g2d.getRenderingHints();
