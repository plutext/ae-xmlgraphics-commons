...
/* $Id: ImageIOImageWriter.java 750418M 2012-05-15 23:17:34Z (local) $ */
 ...
 *
 * @version $Id: ImageIOImageWriter.java 750418M 2012-05-15 23:17:34Z (local) $
 */
public class ImageIOImageWriter implements ImageWriter, IIOWriteWarningListener {
    ...
    /**
     * @see ImageWriter#writeImage(ae.java.awt.image.RenderedImage, java.io.OutputStream)
     */
    ...
    /**
     * @see ImageWriter#writeImage(ae.java.awt.image.RenderedImage, java.io.OutputStream, ImageWriterParams)
     */
    public void writeImage(RenderedImage image, OutputStream out,
            ImageWriterParams params)
                throws IOException {
        ae.javax.imageio.ImageWriter iiowriter = getIIOImageWriter();
    ...
    private ae.javax.imageio.ImageWriter getIIOImageWriter() {
        Iterator iter = ImageIO.getImageWritersByMIMEType(getMIMEType());
        ae.javax.imageio.ImageWriter iiowriter = null;
        if (iter.hasNext()) {
            iiowriter = (ae.javax.imageio.ImageWriter)iter.next();
        }
        if (iiowriter == null) {
    ...
    protected ImageWriteParam getDefaultWriteParam(
            ae.javax.imageio.ImageWriter iiowriter, RenderedImage image,
            ImageWriterParams params) {
    ...
    /**
     * @see ae.javax.imageio.event.IIOWriteWarningListener#warningOccurred(
     *          ae.javax.imageio.ImageWriter, int, java.lang.String)
     */
    public void warningOccurred(ae.javax.imageio.ImageWriter source,
