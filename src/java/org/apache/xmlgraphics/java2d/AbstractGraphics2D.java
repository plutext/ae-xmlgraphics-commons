...
/* $Id: AbstractGraphics2D.java 1311918M 2012-05-15 08:52:01Z (local) $ */
...
/**
 * This extension of the <tt>ae.java.awt.Graphics2D</tt> abstract class
 ...
 * @version $Id: AbstractGraphics2D.java 1311918M 2012-05-15 08:52:01Z (local) $
...
public abstract class AbstractGraphics2D extends Graphics2D implements Cloneable {
     ...
     * @see          ae.java.awt.Graphics#fillPolygon(int[],int[],int)
     ...
     * @see ae.java.awt.Graphics2D#drawString (java.text.AttributedCharacterIterator,
     *      float, float)
     */
     ...
     *        rendered
     *
     * @see ae.java.awt.Font#createGlyphVector(FontRenderContext, char[])
     ...
     * @see ae.java.awt.Graphics#setPaintMode
     * @see ae.java.awt.AlphaComposite
     */
     ...
     * {@link ae.java.awt.Graphics#setClip(Shape) setClip} with a
